...
export default function login() {
  ...
  const { googleLogin, updateUser, signInWithEmail } = useContext(AuthContext)
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
          <div className="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
              <h2 className="mt-6 mb-4 text-3xl/9 font-bold tracking-tight text-gray-900">
            ...
            <div>
              ...
              <div className="mt-6 grid gap-4" onClick={handleSignInWithGoogle}>
                <a
                  href="#"
