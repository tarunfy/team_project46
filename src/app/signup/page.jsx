...
const SignUp = () => {
  ...
  const { googleLogin, signUpWithEmail, updateUser } = useContext(AuthContext)

  //signUp using email
  const handleSignUpWithEmail = async (e) => {
    e.preventDefault()
    const errorMessage = checkPasswordMatch(password, confirmPassword)
    if (errorMessage) {
    ...
    if (loggedInUser != null) {
      ...
      console.log('succesfully logges in')
...
const checkPasswordMatch = (password, confirmPassword) => {
  if (password !== confirmPassword) {
    ...
    return 'password should atleast have 6 letters'
  }
  return '' // Return an empty string if the passwords match
}
